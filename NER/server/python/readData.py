...
def readCorpus2():
    ...
    for i in range(1,9):
        try:
            with open(path.relpath("NYT_column/NYT19980921.000"+str(i))) as f:
                content = f.read().splitlines()
        except:
            pass
    ...
    for i in range(10,99):
        try:
            with open(path.relpath("NYT_column/NYT19980921.00"+str(i))) as f:
    ...
    for i in range(100,101):
        try:
            with open(path.relpath("NYT_column/NYT19980921.0"+str(i))) as f:
                content = content + f.read().splitlines()
        except:
            pass
